 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(N,G){var j=N.length;N.push(G);e:for(;0<j;){var re=j-1>>>1,me=N[re];if(0<r(me,G))N[re]=G,N[j]=me,j=re;else break e}}function t(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var G=N[0],j=N.pop();if(j!==G){N[0]=j;e:for(var re=0,me=N.length,je=me>>>1;re<je;){var W=2*(re+1)-1,ne=N[W],ce=W+1,oe=N[ce];if(0>r(ne,j))ce<me&&0>r(oe,ne)?(N[re]=oe,N[ce]=j,re=ce):(N[re]=ne,N[W]=j,re=W);else if(ce<me&&0>r(oe,j))N[re]=oe,N[ce]=j,re=ce;else break e}}return G}function r(N,G){var j=N.sortIndex-G.sortIndex;return j!==0?j:N.id-G.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],c=[],u=1,d=null,f=3,p=!1,v=!1,y=!1,m=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(N){for(var G=t(c);G!==null;){if(G.callback===null)i(c);else if(G.startTime<=N)i(c),G.sortIndex=G.expirationTime,e(l,G);else break;G=t(c)}}function M(N){if(y=!1,g(N),!v)if(t(l)!==null)v=!0,$(C);else{var G=t(c);G!==null&&J(M,G.startTime-N)}}function C(N,G){v=!1,y&&(y=!1,h(b),b=-1),p=!0;var j=f;try{for(g(G),d=t(l);d!==null&&(!(d.expirationTime>G)||N&&!D());){var re=d.callback;if(typeof re=="function"){d.callback=null,f=d.priorityLevel;var me=re(d.expirationTime<=G);G=n.unstable_now(),typeof me=="function"?d.callback=me:d===t(l)&&i(l),g(G)}else i(l);d=t(l)}if(d!==null)var je=!0;else{var W=t(c);W!==null&&J(M,W.startTime-G),je=!1}return je}finally{d=null,f=j,p=!1}}var A=!1,w=null,b=-1,T=5,S=-1;function D(){return!(n.unstable_now()-S<T)}function F(){if(w!==null){var N=n.unstable_now();S=N;var G=!0;try{G=w(!0,N)}finally{G?I():(A=!1,w=null)}}else A=!1}var I;if(typeof _=="function")I=function(){_(F)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,Y=X.port2;X.port1.onmessage=F,I=function(){Y.postMessage(null)}}else I=function(){m(F,0)};function $(N){w=N,A||(A=!0,I())}function J(N,G){b=m(function(){N(n.unstable_now())},G)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(N){N.callback=null},n.unstable_continueExecution=function(){v||p||(v=!0,$(C))},n.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<N?Math.floor(1e3/N):5},n.unstable_getCurrentPriorityLevel=function(){return f},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(N){switch(f){case 1:case 2:case 3:var G=3;break;default:G=f}var j=f;f=G;try{return N()}finally{f=j}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(N,G){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var j=f;f=N;try{return G()}finally{f=j}},n.unstable_scheduleCallback=function(N,G,j){var re=n.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?re+j:re):j=re,N){case 1:var me=-1;break;case 2:me=250;break;case 5:me=1073741823;break;case 4:me=1e4;break;default:me=5e3}return me=j+me,N={id:u++,callback:G,priorityLevel:N,startTime:j,expirationTime:me,sortIndex:-1},j>re?(N.sortIndex=j,e(c,N),t(l)===null&&N===t(c)&&(y?(h(b),b=-1):y=!0,J(M,j-re))):(N.sortIndex=me,e(l,N),v||p||(v=!0,$(C))),N},n.unstable_shouldYield=D,n.unstable_wrapCallback=function(N){var G=f;return function(){var j=f;f=G;try{return N.apply(this,arguments)}finally{f=j}}}})(Ng);Ig.exports=Ng;var ey=Ig.exports;/**
 * @license React
...
`)+`
`+h);const g=_+m+o,M=_+h+a,C=km(r,r.VERTEX_SHADER,g),A=km(r,r.FRAGMENT_SHADER,M);r.attachShader(y,C),r.attachShader(y,A),t.index0AttributeName!==void 0?r.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function w(D){if(n.debug.checkShaderErrors){const F=r.getProgramInfoLog(y).trim(),I=r.getShaderInfoLog(C).trim(),X=r.getShaderInfoLog(A).trim();let Y=!0,$=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(Y=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,y,C,A);else{const J=Bm(r,C,"vertex"),N=Bm(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
